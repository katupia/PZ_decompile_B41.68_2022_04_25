...
public final class DrainableComboItem extends InventoryItem implements Drainable, IUpdater {
   ...
   public void update() {
               ...
               if (var3 != this.LastCookMinute) {
                  ...
                  if (!this.isCooked() && this.CookingTime > this.MinutesToCook) {
                     ...
                     if (this.getReplaceOnCooked() != null) {
                        for(int var5 = 0; var5 < this.getReplaceOnCooked().size(); ++var5) {
                           InventoryItem var6 = this.container.AddItem((String)this.getReplaceOnCooked().get(var5));
                           if (var6 != null) {
                              if (var6 instanceof DrainableComboItem) {
                                 ((DrainableComboItem)var6).setUsedDelta(this.getUsedDelta());
                              }

                              var6.copyConditionModData(this);
                           }
                        }
         ...
         if (this.container != null && this.container.parent instanceof IsoPlayer) {
            for(var3 = 0; var3 < IsoPlayer.numPlayers; ++var3) {
               if (this.container.parent == IsoPlayer.players[var3]) {
                  var7 = IsoPlayer.players[var3];
               }
            }
         }

         if (var7 != null && (this.canBeActivated() && this.isActivated() || !this.canBeActivated()) && (var7.isHandItem(this) || var7.isAttachedItem(this))) {
      ...
      if (this.getWorldItem() != null && this.canStoreWater() && this.isWaterSource() && RainManager.isRaining() && this.getRainFactor() > 0.0F) {
         IsoGridSquare var8 = this.getWorldItem().getSquare();
         if (var8 != null && var8.isOutside()) {
