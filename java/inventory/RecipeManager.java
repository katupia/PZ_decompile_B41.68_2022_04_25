...
public final class RecipeManager {
   ...
   private static void LoadedAfterLua(Recipe.Source var0, ArrayList<Item> var1) {
   ...
   private static RecipeManager.SourceItems getAvailableItems(Recipe var0, IsoGameCharacter var1, ArrayList<ItemContainer> var2, InventoryItem var3, ArrayList<InventoryItem> var4, boolean var5) {
   ...
   public static InventoryItem PerformMakeItem(Recipe var0, InventoryItem var1, IsoGameCharacter var2, ArrayList<ItemContainer> var3) {
      ...
      if (var7.isEmpty()) {
         ...
         if (var0.LuaCreate != null) {
            ...
            if (var30 != null) {
               LuaManager.caller.protectedCall(LuaManager.thread, var30, new Object[]{var7, var9, var2, var1, var4, var5});
            }
         }
   ...
   private static final class SourceItems {
      ...
      SourceItems(Recipe var1, IsoGameCharacter var2, InventoryItem var3, ArrayList<InventoryItem> var4) {
   ...
   private static final class RMRecipeItemList {
      ...
      void getItemsFrom(ArrayList<RecipeManager.RMRecipeItem> var1, RecipeManager.RMRecipe var2) {
