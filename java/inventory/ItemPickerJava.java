...
public final class ItemPickerJava {
   ...
   private static ArrayList<ItemPickerJava.ProceduralItem> ExtractProcList(KahluaTableImpl var0) {
   ...
   private static void rollProceduralItem(ArrayList<ItemPickerJava.ProceduralItem> var0, ItemContainer var1, float var2, IsoGameCharacter var3, ItemPickerJava.ItemPickerRoom var4) {
      ...
      for(int var10 = 0; (float)var10 < var0.rolls; ++var10) {
         ...
         for(int var12 = 0; var12 < var11.length; ++var12) {
            ...
            if ((float)Rand.Next(10000) <= var14 * 100.0F * var15 + var2 * 10.0F) {
               ...
               if (var16.getScriptItem().getRecordedMediaCat() != null) {
                  String var21 = var16.getScriptItem().getRecordedMediaCat();
                  MediaData var23 = ZomboidRadio.getInstance().getRecordedMedia().getRandomFromCategory(var21);
                  var16.setRecordedMediaData(var23);
               }
               ...
               if (!var22 && Rand.Next(100) < 40 && var16 instanceof DrainableComboItem) {
                  float var24 = 1.0F / ((DrainableComboItem)var16).getUseDelta();
                  ((DrainableComboItem)var16).setUsedDelta(Rand.Next(1.0F, var24 - 1.0F) * ((DrainableComboItem)var16).getUseDelta());
               }

               if (!var22 && var16 instanceof HandWeapon && Rand.Next(100) < 40) {
               ...
               if (var16 instanceof InventoryContainer && containers.containsKey(var16.getType())) {
                  ItemPickerJava.ItemPickerContainer var25 = (ItemPickerJava.ItemPickerContainer)containers.get(var16.getType());
                  if (var4 && Rand.Next(var25.fillRand) == 0) {
