   ...
   public void DoTooltip(ObjectTooltip var1) {
      ...
      if (Core.getInstance().getOptionShowItemModInfo() && !this.isVanilla()) {
         ...
         if (var11 != null && var11.getModOverrides() != null) {
            var16 = var15.addItem();
            float var12 = 0.5F;
            if (var11.getModOverrides().size() == 1) {
               var16.setLabel("This item overrides: " + WorldDictionary.getModNameFromID((String)var11.getModOverrides().get(0)), var12, var12, var12, 1.0F);
            } else {
