...
public class LoadingQueueState extends GameState {
   ...
   private static LoadingQueueUI ui = new LoadingQueueUI();
   ...
   public GameStateMachine.StateAction update() {
      ...
      } else if ((GameWindow.ActivatedJoyPad == null || !GameWindow.ActivatedJoyPad.isAPressed()) && !Keyboard.isKeyDown(1) && GameClient.instance.bConnected) {
