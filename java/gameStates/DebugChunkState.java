...
public final class DebugChunkState extends GameState {
   ...
   private void drawZones() {
      ...
      PolygonalMap2.LiangBarsky var16 = new PolygonalMap2.LiangBarsky();
      double[] var17 = new double[2];
      IsoChunk var18 = IsoWorld.instance.CurrentCell.getChunkForGridSquare(this.gridX, this.gridY, this.m_z);
      ...
      for(var5 = 0; var5 < var1.size(); ++var5) {
         IsoMetaGrid.Zone var20 = (IsoMetaGrid.Zone)var1.get(var5);
         if (var20 != null && var20.isPolyline() && !var20.points.isEmpty()) {
            for(var7 = 0; var7 < var20.points.size() - 2; var7 += 2) {
               var8 = var20.points.get(var7);
               int var9 = var20.points.get(var7 + 1);
               var10 = var20.points.get(var7 + 2);
               var11 = var20.points.get(var7 + 3);
               ...
               if (var18 != null && var16.lineRectIntersect((float)var8, (float)var9, var12, var13, (float)(var18.wx * 10), (float)(var18.wy * 10), (float)(var18.wx * 10 + 10), (float)(var18.wy * 10 + 10), var17)) {
                  this.DrawIsoLine((float)var8 + (float)var17[0] * var12, (float)var9 + (float)var17[0] * var13, (float)var8 + (float)var17[1] * var12, (float)var9 + (float)var17[1] * var13, 0.0F, 1.0F, 0.0F, 1.0F, 1);
               }
            }

            if (var20.polylineOutlinePoints != null) {
               float[] var22 = var20.polylineOutlinePoints;

               for(var8 = 0; var8 < var22.length; var8 += 2) {
                  var25 = var22[var8];
                  float var26 = var22[var8 + 1];
                  float var27 = var22[(var8 + 2) % var22.length];
                  var12 = var22[(var8 + 3) % var22.length];
                  this.DrawIsoLine(var25, var26, var27, var12, 1.0F, 1.0F, 0.0F, 1.0F, 1);
               }
            }
         }
      }

      IsoMetaGrid.VehicleZone var19 = IsoWorld.instance.MetaGrid.getVehicleZoneAt(this.gridX, this.gridY, this.m_z);
      if (var19 != null) {
         float var21 = 0.5F;
         float var23 = 1.0F;
         float var24 = 0.5F;
         ...
         int var30;
         if (var19.isPolygon()) {
            for(var10 = 0; var10 < var19.points.size(); var10 += 2) {
               var11 = var19.points.get(var10);
               var29 = var19.points.get(var10 + 1);
               var30 = var19.points.get((var10 + 2) % var19.points.size());
               var14 = var19.points.get((var10 + 3) % var19.points.size());
               this.DrawIsoLine((float)var11, (float)var29, (float)var30, (float)var14, 1.0F, 1.0F, 0.0F, 1.0F, 1);
            }
         } else if (var19.isPolyline()) {
            for(var10 = 0; var10 < var19.points.size() - 2; var10 += 2) {
               var11 = var19.points.get(var10);
               var29 = var19.points.get(var10 + 1);
               var30 = var19.points.get(var10 + 2);
               var14 = var19.points.get(var10 + 3);
               this.DrawIsoLine((float)var11, (float)var29, (float)var30, (float)var14, 1.0F, 1.0F, 0.0F, 1.0F, 1);
            }

            if (var19.polylineOutlinePoints != null) {
               float[] var28 = var19.polylineOutlinePoints;

               for(var11 = 0; var11 < var28.length; var11 += 2) {
                  var12 = var28[var11];
                  var13 = var28[var11 + 1];
                  float var31 = var28[(var11 + 2) % var28.length];
                  float var15 = var28[(var11 + 3) % var28.length];
                  this.DrawIsoLine(var12, var13, var31, var15, 1.0F, 1.0F, 0.0F, 1.0F, 1);
               }
            }
         } else {
            this.DrawIsoLine((float)var19.x, (float)var19.y, (float)(var19.x + var19.w), (float)var19.y, var21, var23, var24, var25, 1);
            this.DrawIsoLine((float)var19.x, (float)(var19.y + var19.h), (float)(var19.x + var19.w), (float)(var19.y + var19.h), var21, var23, var24, var25, 1);
            this.DrawIsoLine((float)var19.x, (float)var19.y, (float)var19.x, (float)(var19.y + var19.h), var21, var23, var24, var25, 1);
            this.DrawIsoLine((float)(var19.x + var19.w), (float)var19.y, (float)(var19.x + var19.w), (float)(var19.y + var19.h), var21, var23, var24, var25, 1);
         }
      }
