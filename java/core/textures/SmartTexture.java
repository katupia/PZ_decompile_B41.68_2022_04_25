...
public class SmartTexture extends Texture {
   ...
   public Texture addHole(BloodBodyPartType var1) {
      ...
      this.clear();
      this.result = null;
      this.commands.add(TextureCombinerCommand.get().initSeparate(var3, addHole, addHoleParams, Texture.getSharedTexture(var2), 770, 0, 1, 771));
      this.dirty = true;
      return var3;
   }
   ...
   public void addSeparate(String var1, int var2, int var3, int var4, int var5) {
      this.addSeparate(Texture.getSharedTexture(var1), var2, var3, var4, var5);
   }
   ...
   public void addSeparate(String var1, SmartShader var2, String var3, ArrayList<TextureCombinerShaderParam> var4, int var5, int var6, int var7, int var8) {
      this.addSeparate(Texture.getSharedTexture(var1), var2, Texture.getSharedTexture(var3), var4, var5, var6, var7, var8);
   }
