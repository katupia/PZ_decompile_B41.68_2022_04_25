...
public class VoiceManager {
   ...
   public void ResetRecSound() {
      ...
      if (this.initialiseRecDev) {
         int var1 = javafmod.FMOD_System_RecordStart(this.FMODVoiceRecordDriverId, this.FMODRecordSound, true);
                           ...
                           if (var11 != null) {
                              ...
                              if (var11.getWorldObjects() != null) {
                                 for(var12 = 0; var12 < var11.getWorldObjects().size(); ++var12) {
                                    IsoWorldInventoryObject var21 = (IsoWorldInventoryObject)var11.getWorldObjects().get(var12);
                                    if (var21.getItem() != null && var21.getItem() instanceof Radio) {
                                       var14 = ((Radio)var21.getItem()).getDeviceData();
                                       if (var14 != null && var14.getIsTurnedOn()) {
                                          var3.radioData.add(new VoiceManagerData.RadioData(var14, (float)var11.x, (float)var11.y));
                                       }
                                    }
