...
public class UdpEngine {
   ...
   private void decode(ByteBuffer var1) {
      ...
      case 16:
         ...
         var6 = this.addConnection(var10, var4);
      ...
      case 19:
         var10 = var1.get() & 255;
         var4 = this.peer.getGuidOfPacket();
         this.addConnection(var10, var4);
         break;
      case 21:
         var10 = var1.get() & 255;
         var4 = this.peer.getGuidOfPacket();
         this.removeConnection(var10);
         ConnectionManager.log("Receive Disconnect [" + var2 + "]", (UdpConnection)null);
         if (GameClient.bClient) {
            GameClient.instance.addDisconnectPacket(var2);
         }
         break;
      case 22:
         var10 = var1.get() & 255;
         if (GameServer.bServer && this.connectionArray[var10] != null) {
            DebugLog.log("Connection Lost for id=" + var10 + " username=" + this.connectionArray[var10].username);
         } else {
      ...
      case 32:
         ...
         break;
      case 44:
         var9 = this.peer.getGuidOfPacket();
         VoiceManager.instance.VoiceConnectAccept(var9);
         break;
      case 45:
         var9 = this.peer.getGuidOfPacket();
         VoiceManager.instance.VoiceOpenChannelReply(var9, var1);
         break;
      case 134:
      ...
      default:
         ...
         if (GameServer.bServer) {
            var9 = this.peer.getGuidOfPacket();
            UdpConnection var5 = (UdpConnection)this.connectionMap.get(var9);

            try {
               if (ServerOptions.instance.AntiCheatProtectionType10.getValue() && PacketValidator.doKickUser(var5, String.valueOf(var2), "UI_ValidationFailed_Type10")) {
                  LoggerManager.getLogger("kick").write(String.format("Kick: player=\"%s\" type=\"%s\" issuer=\"%s\" description=\"%s\"", var5.username, "UI_ValidationFailed_Type10", String.valueOf(var2), this.getDescription()));
               }
