...
public class RenderThread {
   ...
   public static <T1> void invokeOnRenderContext(T1 var0, Invokers.Params1.ICallback<T1> var1) {
      Lambda.capture(var0, var1, (var0x, var1x, var2) -> {
         invokeOnRenderContext(var0x.invoker(var1x, var2));
      });
   }

   public static <T1, T2> void invokeOnRenderContext(T1 var0, T2 var1, Invokers.Params2.ICallback<T1, T2> var2) {
      Lambda.capture(var0, var1, var2, (var0x, var1x, var2x, var3) -> {
         invokeOnRenderContext(var0x.invoker(var1x, var2x, var3));
      });
   }

   public static <T1, T2, T3> void invokeOnRenderContext(T1 var0, T2 var1, T3 var2, Invokers.Params3.ICallback<T1, T2, T3> var3) {
   ...
   public static <T1, T2, T3, T4> void invokeOnRenderContext(T1 var0, T2 var1, T3 var2, T4 var3, Invokers.Params4.ICallback<T1, T2, T3, T4> var4) {
