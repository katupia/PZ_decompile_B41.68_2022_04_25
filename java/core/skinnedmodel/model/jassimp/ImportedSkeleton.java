...
public final class ImportedSkeleton {
   ...
   private void addDefaultAnimTrack(String var1, int var2, Quaternion var3, Vector3f var4, ArrayList<Keyframe> var5, float var6) {
   ...
   private boolean doesParentBoneHaveAnimFrames(TFloatArrayList[] var1, ArrayList<ArrayList<AiNodeAnim>> var2, int var3) {
      int var4 = this.getParentBoneIdx(var3);
      return var4 < 0 ? false : this.doesBoneHaveAnimFrames(var1, var2, var4);
   }

   private boolean doesBoneHaveAnimFrames(TFloatArrayList[] var1, ArrayList<ArrayList<AiNodeAnim>> var2, int var3) {
   ...
   private void collectBoneFrames(AiAnimation var1, TFloatArrayList[] var2, ArrayList<ArrayList<AiNodeAnim>> var3) {
