         ...
         if (!Core.Option3DGroundItem) {
            ...
            if (!StringUtils.isNullOrEmpty(var0.getWorldStaticItem())) {
               ...
               if (var7 != null) {
                  ...
                  if (var27 != null && var27.isReady()) {
                     var15 = (WorldItemModelDrawer)s_modelDrawerPool.alloc();
                     var15.init(var0, var1, var2, var3, var4, var27, var12, var11, var5);
                     if (var7.scale != 1.0F) {
               ...
               if (var18 != null && var19 != null && "Bip01_Head".equalsIgnoreCase(var18.m_AttachBone) && (!((Clothing)var0).isCosmetic() || "Eyes".equals(var0.getBodyLocation()))) {
                  ...
                  if (!StringUtils.isNullOrWhitespace(var10)) {
                     ...
                     if (var27 != null && var27.isReady()) {
                        var15 = (WorldItemModelDrawer)s_modelDrawerPool.alloc();
                        float var32 = var19.getHue(var18);
                        ImmutableColor var17 = var19.getTint(var18);
                        var15.init(var0, var1, var2, var3, var4, var27, var32, var17, var5);
                        if (NEW_WAY) {
            ...
            if (var0 instanceof HandWeapon) {
               ...
               if (var7 != null) {
                  ...
                  if (var24 != null && var24.isReady()) {
                     ...
                     var29.init(var0, var1, var2, var3, var4, var24, var31, var30, var5);
                     if (var7.scale != 1.0F) {
                        var29.m_transform.scale(var7.scale);
                     }

                     if (var0.worldScale != 1.0F) {
                        var29.m_transform.scale(var7.scale * var0.worldScale);
                     }
                     ...
                     if (NEW_WAY) {
                        ...
                        var29.m_transform.mul(s_attachmentXfrm);
                     }
      ...
      if (this.m_model.bStatic) {
         ...
         if (var2 != null && var1.Mesh != null && var1.Mesh.isReady()) {
            ...
            for(int var3 = 0; var3 < 5; ++var3) {
               var2.setLight(var3, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F / 0.0, 0.0F, 0.0F, 0.0F, (IsoMovingObject)null);
            }
            ...
            float var4 = 1.5F;
            var2.setLight(4, var5.x, var5.z, var5.y, this.m_ambientR / 4.0F * var4, this.m_ambientG / 4.0F * var4, this.m_ambientB / 4.0F * var4, 5000.0F, 0.0F / 0.0, 0.0F, 0.0F, 0.0F, (IsoMovingObject)null);
