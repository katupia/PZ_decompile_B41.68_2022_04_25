...
public class LiveAnimNode extends PooledObject implements IAnimListener {
   ...
   public float getTransitionInBlendInTime() {
      return this.m_transitionIn.m_data != null && this.m_transitionIn.m_data.m_blendInTime != 1.0F / 0.0 ? this.m_transitionIn.m_data.m_blendInTime : 0.0F;
   }
   ...
   public float getBlendInTime() {
      ...
      } else if (this.m_transitionIn.m_track != null && this.m_transitionIn.m_data.m_blendOutTime != 1.0F / 0.0) {
         return this.m_transitionIn.m_data.m_blendOutTime;
      } else {
         if (this.m_transitionIn.m_track == null) {
            if (this.m_transitionIn.m_data.m_blendInTime != 1.0F / 0.0) {
               return this.m_transitionIn.m_data.m_blendInTime;
            }

            if (this.m_transitionIn.m_data.m_blendOutTime != 1.0F / 0.0) {
               return this.m_transitionIn.m_data.m_blendOutTime;
            }
         }
   ...
   public float getBlendOutTime() {
      ...
      } else if (!StringUtils.isNullOrWhitespace(this.m_transitionOut.m_AnimName) && this.m_transitionOut.m_blendInTime != 1.0F / 0.0) {
         return this.m_transitionOut.m_blendInTime;
      } else {
         if (StringUtils.isNullOrWhitespace(this.m_transitionOut.m_AnimName)) {
            if (this.m_transitionOut.m_blendOutTime != 1.0F / 0.0) {
               return this.m_transitionOut.m_blendOutTime;
            }

            if (this.m_transitionOut.m_blendInTime != 1.0F / 0.0) {
               return this.m_transitionOut.m_blendInTime;
            }
         }
