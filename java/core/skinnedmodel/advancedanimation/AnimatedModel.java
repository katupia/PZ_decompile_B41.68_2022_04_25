...
public final class AnimatedModel extends AnimationVariableSource implements IAnimatable, IAnimEventCallback, IActionStateChanged, IHumanVisual {
   ...
   private static final ObjectPool<AnimatedModel.AnimatedModelInstanceRenderData> instDataPool = new ObjectPool(AnimatedModel.AnimatedModelInstanceRenderData::new);
   ...
   private void release(ArrayList<AnimatedModel.AnimatedModelInstanceRenderData> var1) {
                  ...
                  if (var2.model.isReady()) {
                     if (var2.tex != null || var2.model.tex != null) {
                        ...
                        if (var4 != null) {
                           ...
                           var4.setLight(0, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F / 0.0, var2);
                           var4.setLight(1, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F / 0.0, var2);
                           var4.setLight(2, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F / 0.0, var2);
                           var4.setLight(3, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F / 0.0, var2);
                           var4.setLight(4, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F / 0.0, var2);
                           float var5 = 0.7F;
   ...
   private static final class AnimatedModelInstanceRenderData {
      ...
      AnimatedModel.AnimatedModelInstanceRenderData init(ModelInstance var1) {
         ...
         this.xfrm.identity();
         this.m_animPlayerAngle = 0.0F / 0.0;
