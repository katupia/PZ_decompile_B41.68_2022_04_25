...
public class PerformanceProfileProbeList<Probe extends PerformanceProfileProbe> {
   ...
   public static <Probe extends PerformanceProfileProbe> PerformanceProfileProbeList<Probe> construct(String var0, int var1, Class<Probe> var2, PerformanceProfileProbeList.Constructor<Probe> var3) {
      return new PerformanceProfileProbeList(var0, var1, var2, var3);
   }

   protected PerformanceProfileProbeList(String var1, int var2, Class<Probe> var3, PerformanceProfileProbeList.Constructor<Probe> var4) {
      this.m_prefix = var1;
