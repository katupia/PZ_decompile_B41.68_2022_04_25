...
public class NonBlockingIdentityHashMap<TypeK, TypeV> extends AbstractMap<TypeK, TypeV> implements ConcurrentMap<TypeK, TypeV>, Cloneable, Serializable {
   ...
   private static final class CHM<TypeK, TypeV> {
      ...
      private final AtomicReferenceFieldUpdater<NonBlockingIdentityHashMap.CHM, Object[]> _newkvsUpdater = AtomicReferenceFieldUpdater.newUpdater(NonBlockingIdentityHashMap.CHM.class, Object[].class, "_newkvs");
      volatile long _resizers;
      private static final AtomicLongFieldUpdater<NonBlockingIdentityHashMap.CHM> _resizerUpdater = AtomicLongFieldUpdater.newUpdater(NonBlockingIdentityHashMap.CHM.class, "_resizers");
      volatile long _copyIdx = 0L;
      private static final AtomicLongFieldUpdater<NonBlockingIdentityHashMap.CHM> _copyIdxUpdater = AtomicLongFieldUpdater.newUpdater(NonBlockingIdentityHashMap.CHM.class, "_copyIdx");
      volatile long _copyDone = 0L;
      private static final AtomicLongFieldUpdater<NonBlockingIdentityHashMap.CHM> _copyDoneUpdater = AtomicLongFieldUpdater.newUpdater(NonBlockingIdentityHashMap.CHM.class, "_copyDone");
