...
public class NonBlockingHashtable<TypeK, TypeV> extends Dictionary<TypeK, TypeV> implements ConcurrentMap<TypeK, TypeV>, Cloneable, Serializable {
   ...
   private static final NonBlockingHashtable.CHM chm(Object[] var0) {
      return (NonBlockingHashtable.CHM)var0[0];
   }
   ...
   private final void print(Object[] var1) {
      for(int var2 = 0; var2 < len(var1); ++var2) {
         ...
         if (var3 != null) {
            ...
            Object var6 = NonBlockingHashtable.Prime.unbox(var5);
   ...
   private final void print2(Object[] var1) {
      for(int var2 = 0; var2 < len(var1); ++var2) {
         ...
         Object var5 = NonBlockingHashtable.Prime.unbox(var4);
   ...
   private final TypeV putIfMatch(Object var1, Object var2, Object var3) {
      if (var3 != null && var2 != null) {
         ...
         assert !(var4 instanceof NonBlockingHashtable.Prime);
   ...
   public TypeV get(Object var1) {
      ...
      assert !(var3 instanceof NonBlockingHashtable.Prime);
   ...
   private static final Object get_impl(NonBlockingHashtable var0, Object[] var1, Object var2, int var3) {
      int var4 = len(var1);
      NonBlockingHashtable.CHM var5 = chm(var1);
      ...
      while(true) {
         ...
         if (keyeq(var9, var2, var6, var7, var3)) {
            if (!(var10 instanceof NonBlockingHashtable.Prime)) {
   ...
   private static final Object putIfMatch(NonBlockingHashtable var0, Object[] var1, Object var2, Object var3, Object var4) {
      ...
      int var5 = hash(var2);
      int var6 = len(var1);
      NonBlockingHashtable.CHM var7 = chm(var1);
      ...
      if (var3 == var12) {
         ...
         if (var13 == null && (var12 == null && var7.tableFull(var10, var6) || var12 instanceof NonBlockingHashtable.Prime)) {
            var13 = var7.resize(var0, var1);
         }
         ...
         if (var13 != null) {
            ...
            do {
               assert !(var12 instanceof NonBlockingHashtable.Prime);
               ...
               var12 = val(var1, var9);
            } while(!(var12 instanceof NonBlockingHashtable.Prime));
   ...
   private final Object[] help_copy(Object[] var1) {
      ...
      NonBlockingHashtable.CHM var3 = chm(var2);
   ...
   private static final class CHM<TypeK, TypeV> {
      ...
      private final AtomicReferenceFieldUpdater<NonBlockingHashtable.CHM, Object[]> _newkvsUpdater = AtomicReferenceFieldUpdater.newUpdater(NonBlockingHashtable.CHM.class, Object[].class, "_newkvs");
      volatile long _resizers;
      private static final AtomicLongFieldUpdater<NonBlockingHashtable.CHM> _resizerUpdater = AtomicLongFieldUpdater.newUpdater(NonBlockingHashtable.CHM.class, "_resizers");
      volatile long _copyIdx = 0L;
      private static final AtomicLongFieldUpdater<NonBlockingHashtable.CHM> _copyIdxUpdater = AtomicLongFieldUpdater.newUpdater(NonBlockingHashtable.CHM.class, "_copyIdx");
      volatile long _copyDone = 0L;
      private static final AtomicLongFieldUpdater<NonBlockingHashtable.CHM> _copyDoneUpdater = AtomicLongFieldUpdater.newUpdater(NonBlockingHashtable.CHM.class, "_copyDone");
      ...
      private final boolean tableFull(int var1, int var2) {
         return var1 >= 10 && this._slots.estimate_get() >= (long)NonBlockingHashtable.reprobe_limit(var2);
      }

      private final Object[] resize(NonBlockingHashtable var1, Object[] var2) {
         assert NonBlockingHashtable.chm(var2) == this;
      ...
      private final void help_copy_impl(NonBlockingHashtable var1, Object[] var2, boolean var3) {
         assert NonBlockingHashtable.chm(var2) == this;
      ...
      private final Object[] copy_slot_and_check(NonBlockingHashtable var1, Object[] var2, int var3, Object var4) {
         assert NonBlockingHashtable.chm(var2) == this;
      ...
      private final void copy_check_and_promote(NonBlockingHashtable var1, Object[] var2, int var3) {
         assert NonBlockingHashtable.chm(var2) == this;
      ...
      private boolean copy_slot(NonBlockingHashtable var1, int var2, Object[] var3, Object[] var4) {
         Object var5;
         while((var5 = NonBlockingHashtable.key(var3, var2)) == null) {
            NonBlockingHashtable.CAS_key(var3, var2, (Object)null, NonBlockingHashtable.TOMBSTONE);
         }

         Object var6;
         for(var6 = NonBlockingHashtable.val(var3, var2); !(var6 instanceof NonBlockingHashtable.Prime); var6 = NonBlockingHashtable.val(var3, var2)) {
            NonBlockingHashtable.Prime var7 = var6 != null && var6 != NonBlockingHashtable.TOMBSTONE ? new NonBlockingHashtable.Prime(var6) : NonBlockingHashtable.TOMBPRIME;
         ...
         if (var6 == NonBlockingHashtable.TOMBPRIME) {
            ...
            Object var9 = ((NonBlockingHashtable.Prime)var6)._V;

            assert var9 != NonBlockingHashtable.TOMBSTONE;

            boolean var8;
            for(var8 = NonBlockingHashtable.putIfMatch(var1, var4, var5, var9, (Object)null) == null; !NonBlockingHashtable.CAS_val(var3, var2, var6, NonBlockingHashtable.TOMBPRIME); var6 = NonBlockingHashtable.val(var3, var2)) {
            }
   ...
   private static final class Prime {
      ...
      static Object unbox(Object var0) {
         return var0 instanceof NonBlockingHashtable.Prime ? ((NonBlockingHashtable.Prime)var0)._V : var0;
      }
   }
   ...
   private class SnapshotV implements Iterator<TypeV>, Enumeration<TypeV> {
      ...
      public SnapshotV() {
         while(true) {
            Object[] var2 = NonBlockingHashtable.this._kvs;
            NonBlockingHashtable.CHM var3 = NonBlockingHashtable.chm(var2);
            if (var3._newkvs == null) {
               this._sskvs = var2;
               this.next();
               return;
            ...
            var3.help_copy_impl(NonBlockingHashtable.this, var2, true);
         }
      }
   ...
   private class NBHMEntry extends AbstractEntry<TypeK, TypeV> {
      ...
      public TypeV setValue(TypeV var1) {
         if (var1 == null) {
            ...
            this._val = var1;
            return NonBlockingHashtable.this.put(this._key, var1);
         }
      }
   }
}
