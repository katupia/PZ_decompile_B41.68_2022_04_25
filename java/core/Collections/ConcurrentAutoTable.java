...
public class ConcurrentAutoTable implements Serializable {
   ...
   private static final AtomicReferenceFieldUpdater<ConcurrentAutoTable, ConcurrentAutoTable.CAT> _catUpdater = AtomicReferenceFieldUpdater.newUpdater(ConcurrentAutoTable.class, ConcurrentAutoTable.CAT.class, "_cat");
   ...
   private static class CAT implements Serializable {
      ...
      CAT(ConcurrentAutoTable.CAT var1, int var2, long var3) {
         this._next = var1;
         this._sum_cache = -9223372036854775808L;
      ...
      public long add_if_mask(long var1, long var3, int var5, ConcurrentAutoTable var6) {
         ...
         if (this._sum_cache != -9223372036854775808L) {
            this._sum_cache = -9223372036854775808L;
         }
