...
public class ZomboidHashMap<K, V> extends ZomboidAbstractMap<K, V> implements Map<K, V>, Cloneable, Serializable {
   ...
   Stack<ZomboidHashMap.Entry<K, V>> entryStore;
   ...
   final ZomboidHashMap.Entry<K, V> getEntry(Object var1) {
   ...
   final ZomboidHashMap.Entry<K, V> removeEntryForKey(Object var1) {
      int var2 = var1 == null ? 0 : hash(var1.hashCode());
   ...
   final ZomboidHashMap.Entry<K, V> removeMapping(Object var1) {
   ...
   static class Entry<K, V> implements java.util.Map.Entry<K, V> {
      ...
      Entry(int var1, K var2, V var3, ZomboidHashMap.Entry<K, V> var4) {
         this.value = var3;
         this.next = var4;
         this.key = var2;
         this.hash = var1;
