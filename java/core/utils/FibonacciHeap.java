...
public final class FibonacciHeap<T> {
   ...
   public FibonacciHeap.Entry<T> enqueue(T var1, double var2) {
   ...
   public void decreaseKey(FibonacciHeap.Entry<T> var1, double var2) {
      this.checkPriority(var2);
   ...
   public void delete(FibonacciHeap.Entry<T> var1) {
      this.decreaseKeyUnchecked(var1, -1.0D / 0.0);
      this.dequeueMin();
   }
   ...
   private static <T> FibonacciHeap.Entry<T> mergeLists(FibonacciHeap.Entry<T> var0, FibonacciHeap.Entry<T> var1) {
   ...
   private void decreaseKeyUnchecked(FibonacciHeap.Entry<T> var1, double var2) {
      var1.mPriority = var2;
   ...
   private void decreaseKeyUncheckedNode(FibonacciHeap.Entry<IsoGridSquare> var1, double var2) {
      var1.mPriority = var2;
      if (var1.mParent != null && var1.mPriority <= var1.mParent.mPriority) {
   ...
   private void cutNode(FibonacciHeap.Entry<T> var1) {
   ...
   private void cutNodeNode(FibonacciHeap.Entry<IsoGridSquare> var1) {
      var1.mIsMarked = false;
      if (var1.mParent != null) {
         if (var1.mNext != var1) {
            var1.mNext.mPrev = var1.mPrev;
