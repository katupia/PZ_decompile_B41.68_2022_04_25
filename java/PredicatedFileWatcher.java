...
public final class PredicatedFileWatcher {
   ...
   public PredicatedFileWatcher(Predicate<String> var1, PredicatedFileWatcher.IPredicatedFileWatcherCallback var2) {
   ...
   public <T> PredicatedFileWatcher(String var1, Class<T> var2, PredicatedFileWatcher.IPredicatedDataPacketFileWatcherCallback<T> var3) {
   ...
   public PredicatedFileWatcher(String var1, Predicate<String> var2, PredicatedFileWatcher.IPredicatedFileWatcherCallback var3) {
   ...
   public static class GenericPredicatedFileWatcherCallback<T> implements PredicatedFileWatcher.IPredicatedFileWatcherCallback {
      ...
      public GenericPredicatedFileWatcherCallback(Class<T> var1, PredicatedFileWatcher.IPredicatedDataPacketFileWatcherCallback<T> var2) {
         this.m_class = var1;
