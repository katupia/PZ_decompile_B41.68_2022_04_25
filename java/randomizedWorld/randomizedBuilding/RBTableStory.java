...
public final class RBTableStory extends RandomizedBuildingBase {
   ...
   private void doSpawnTable(ArrayList<RBTableStory.StorySpawnItem> var1, boolean var2) {
      this.xOffset = 0.0F;
      this.yOffset = 0.0F;
      int var3 = 0;
      if (var2) {
   ...
   public class StoryDef {
      ...
      public StoryDef(ArrayList<RBTableStory.StorySpawnItem> var2) {
         this.items = var2;
      }

      public StoryDef(ArrayList<RBTableStory.StorySpawnItem> var2, ArrayList<String> var3) {
         this.items = var2;
         this.rooms = var3;
      }
   }
