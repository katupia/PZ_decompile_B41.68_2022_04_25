...
public class SafeHouse {
   ...
   public static String canBeSafehouse(IsoGridSquare var0, IsoPlayer var1) {
      if (!GameClient.bClient && !GameServer.bServer) {
         ...
         if (GameClient.bClient) {
            ...
            while(var4.advance()) {
               ...
               while(var7.advance()) {
                  ...
                  while(var9.advance()) {
                     var10 = (KahluaTable)var9.getValue();
         ...
         for(int var25 = var21.getX() - diffError; var25 < var21.getX2() + diffError; ++var25) {
            for(int var26 = var21.getY() - diffError; var26 < var21.getY2() + diffError; ++var26) {
               IsoGridSquare var23 = var0.getCell().getGridSquare(var25, var26, 0);
               if (var23 != null) {
                  for(int var27 = 0; var27 < var23.getMovingObjects().size(); ++var27) {
                     IsoMovingObject var28 = (IsoMovingObject)var23.getMovingObjects().get(var27);
                     if (var28 != var1) {
                        var16 = false;
                        break;
                     }

                     if (!var28.getSquare().Is(IsoFlagType.exterior)) {
                        var17 = true;
                     }
                  }
               }
   ...
   public void checkTrespass(IsoPlayer var1) {
      if (GameServer.bServer && !ServerOptions.instance.SafehouseAllowTrepass.getValue() && var1.getVehicle() == null) {
