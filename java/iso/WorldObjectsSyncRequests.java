...
public final class WorldObjectsSyncRequests {
   ...
   public void putRequest(IsoChunk var1) {
      WorldObjectsSyncRequests.SyncData var2 = new WorldObjectsSyncRequests.SyncData();
      var2.x = var1.wx;
      var2.y = var1.wy;
      ...
      if (this.requests.size() != 0) {
         ...
         synchronized(this.requests) {
            for(int var7 = 0; var7 < this.requests.size(); ++var7) {
               WorldObjectsSyncRequests.SyncData var8 = (WorldObjectsSyncRequests.SyncData)this.requests.get(var7);
               if (var8.reqCount > 2) {
   ...
   public void receiveIsoSync(int var1, int var2) {
      synchronized(this.requests) {
         for(int var4 = 0; var4 < this.requests.size(); ++var4) {
            WorldObjectsSyncRequests.SyncData var5 = (WorldObjectsSyncRequests.SyncData)this.requests.get(var4);
