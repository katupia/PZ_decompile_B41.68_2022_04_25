...
public final class IsoMetaCell {
   ...
   public void getZonesUnique(Set<IsoMetaGrid.Zone> var1) {
   ...
   public void getZonesIntersecting(int var1, int var2, int var3, int var4, int var5, ArrayList<IsoMetaGrid.Zone> var6) {
