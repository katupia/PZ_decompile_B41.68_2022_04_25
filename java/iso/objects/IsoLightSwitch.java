      ...
      if (!GameServer.bServer && !GameClient.bClient || GameServer.bServer) {
         ...
         if (!this.lightRoom && this.canBeModified && this.Activated) {
            ...
            if (GameTime.instance.getMinutesStamp() > this.lastMinuteStamp) {
               ...
               long var10 = GameTime.instance.getMinutesStamp() - this.lastMinuteStamp;
               this.lastMinuteStamp = GameTime.instance.getMinutesStamp();
               boolean var4 = false;
               boolean var5 = GameTime.instance.NightsSurvived < SandboxOptions.instance.getElecShutModifier();
               ...
               if (this.Activated && this.hasLightBulb() && var4) {
                  this.bulbBurnMinutes = (int)((long)this.bulbBurnMinutes + var10);
               }

               this.nextBreakUpdate = (int)((long)this.nextBreakUpdate - var10);
               if (this.nextBreakUpdate <= 0) {
                  if (this.Activated && this.hasLightBulb() && var4) {
                     int var8 = Rand.Next(0, 1000);
                     int var9 = this.bulbBurnMinutes / 10000;
                     if (var8 < var9) {
               ...
               if (this.Activated && var7 && this.hasLightBulb()) {
                  float var11 = this.power - this.power % 0.01F;
                  this.power -= this.delta * (float)var10;
                  if (this.power < 0.0F) {
                     this.power = 0.0F;
                  }

                  if (var10 == 1L || this.power < var11) {
                     var1 = true;
                  }
               }
            }
