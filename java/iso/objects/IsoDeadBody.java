...
public final class IsoDeadBody extends IsoMovingObject implements Talker, IHumanVisual {
   ...
   private static ArrayList<IsoDeadBody> AllBodies = new ArrayList(256);
   private static final ConcurrentHashMap<Short, IsoDeadBody> ClientBodies = new ConcurrentHashMap();
