...
public interface WaveSignalDevice {
   ...
   default void AddDeviceText(IsoPlayer var1, String var2, float var3, float var4, float var5, String var6, int var7) {
      if (this.getDeviceData() != null && this.getDeviceData().getDeviceVolume() > 0.0F) {
         if (!ZomboidRadio.isStaticSound(var2)) {
            this.getDeviceData().doReceiveSignal(var7);
         }
         ...
         if (var1 != null && var1.isLocalPlayer() && !var1.Traits.Deaf.isSet()) {
            ...
            if (var6 != null) {
               LuaEventManager.triggerEvent("OnDeviceText", var6, -1, -1, -1, var2, this);
            }
         }
      }
