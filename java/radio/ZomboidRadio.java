...
public final class ZomboidRadio {
   ...
   private void DistributeToPlayerOnClient(IsoPlayer var1, int var2, int var3, int var4, String var5, String var6, float var7, float var8, float var9, int var10, boolean var11) {
      if (var1 != null) {
         DeviceData var12 = ChatManager.getInstance().getReceivingRadio(var4);
         if (var12 != null) {
            this.DistributeToPlayerInternal(var12.getParent(), var1, var2, var3, var5, var6, var7, var8, var9, var10);
         }
      }
   ...
   private void DistributeToPlayer(IsoPlayer var1, int var2, int var3, int var4, String var5, String var6, float var7, float var8, float var9, int var10, boolean var11) {
      if (var1 != null) {
         ...
         if (var12 != null && var12.getDeviceData() != null && var12.getDeviceData().getIsPortable() && var12.getDeviceData().getIsTurnedOn() && var12.getDeviceData().getChannel() == var4) {
            ...
            this.DistributeToPlayerInternal(var12, var1, var2, var3, var5, var6, var7, var8, var9, var10);
         }
      }

   }

   private void DistributeToPlayerInternal(WaveSignalDevice var1, IsoPlayer var2, int var3, int var4, String var5, String var6, float var7, float var8, float var9, int var10) {
      boolean var11 = false;
      int var12 = -1;
      if (var10 < 0) {
         var11 = true;
      } else {
         var12 = this.GetDistance((int)var2.getX(), (int)var2.getY(), var3, var4);
         if (var12 > 3 && var12 < var10) {
            var11 = true;
         }
      }
      ...
      if (var11) {
         if (var10 > 0) {
            ...
            var5 = this.doDeviceRangeDistortion(var5, var10, var12);
         }

         if (!this.hasAppliedRangeDistortion) {
            var1.AddDeviceText(var2, var5, var7, var8, var9, var6, var12);
         } else {
            var1.AddDeviceText(var5, 0.5F, 0.5F, 0.5F, var6, var12);
         }
      }
   ...
   private void DistributeTransmission(int var1, int var2, int var3, String var4, String var5, float var6, float var7, float var8, int var9, boolean var10) {
      ...
      if (!var10) {
         if (!GameClient.bClient && !GameServer.bServer) {
            ...
            IsoPlayer[] var11 = IsoPlayer.players;
            int var12 = var11.length;

            for(int var13 = 0; var13 < var12; ++var13) {
               IsoPlayer var14 = var11[var13];
               this.DistributeToPlayerOnClient(var14, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10);
            }
            ...
            if (var16 != null && var16.getDeviceData() != null && var16.getDeviceData().getIsTurnedOn() && var10 == var16.getDeviceData().getIsTelevision()) {
               ...
               if (var3 == var16.getDeviceData().getChannel()) {
                  ...
                  if (var17) {
                     ...
                     if (var9 > 0) {
                        this.hasAppliedRangeDistortion = false;
                        var18 = this.GetDistance((int)var16.getX(), (int)var16.getY(), var1, var2);
                        var4 = this.doDeviceRangeDistortion(var4, var9, var18);
                     }

                     if (!this.hasAppliedRangeDistortion) {
                        var16.AddDeviceText(var4, var6, var7, var8, var5, var18);
                     } else {
                        var16.AddDeviceText(var4, 0.5F, 0.5F, 0.5F, var5, var18);
                     }
                  }
               }
            }
   ...
   public void SendTransmission(int var1, int var2, int var3, String var4, String var5, float var6, float var7, float var8, int var9, boolean var10) {
      this.SendTransmission(-1L, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10);
   }

   public void SendTransmission(long var1, int var3, int var4, int var5, String var6, String var7, float var8, float var9, float var10, int var11, boolean var12) {
      GameMode var13 = this.getGameMode();
      if (!var12 && (var13 == GameMode.Server || var13 == GameMode.SinglePlayer)) {
         this.hasAppliedInterference = false;
         var6 = this.applyWeatherInterference(var6, var11);
      ...
      if (var13.equals(GameMode.SinglePlayer)) {
         this.ReceiveTransmission(var3, var4, var5, var6, var7, var8, var9, var10, var11, var12);
      } else if (var13.equals(GameMode.Server)) {
         GameServer.sendIsoWaveSignal(var1, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12);
      } else if (var13.equals(GameMode.Client)) {
         GameClient.sendIsoWaveSignal(var3, var4, var5, var6, var7, var8, var9, var10, var11, var12);
      }
   ...
   public void sendRequestData(ByteBufferWriter var1) {
      this.getRecordedMedia().sendRequestData(var1);
   }

   public static void receiveRequestData(ByteBuffer var0) {
      RecordedMedia.receiveRequestData(var0);
   }
