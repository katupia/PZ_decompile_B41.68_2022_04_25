...
public final class MapGroups {
   ...
   private void getDirsRecursively(MapGroups.MapDirectory var1, ArrayList<MapGroups.MapDirectory> var2) {
   ...
   private MapGroups.MapGroup findGroupWithAnyOfTheseDirectories(ArrayList<MapGroups.MapDirectory> var1) {
   ...
   private class MapDirectory {
      ...
      public MapDirectory(String var2, String var3, ArrayList<String> var4) {
         this.name = var2;
         this.path = var3;
   ...
   private class MapGroup {
      ...
      boolean hasAnyOfTheseDirectories(ArrayList<MapGroups.MapDirectory> var1) {
      ...
      void getDirsRecursively(MapGroups.MapDirectory var1, ArrayList<String> var2) {
