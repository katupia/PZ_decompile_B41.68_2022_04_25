...
public class FakeClientManager {
   ...
   private static HashMap<Integer, FakeClientManager.Movement> load(String var0) {
   ...
   private static class ZombieSimulator {
      ...
      private final HashMap<Integer, FakeClientManager.Zombie> zombies;
      private final ArrayDeque<FakeClientManager.Zombie> zombies4Add;
      private final ArrayDeque<FakeClientManager.Zombie> zombies4Delete;
      private final HashSet<Short> authoriseZombies;
      private final ArrayDeque<FakeClientManager.Zombie> SendQueue;
