...
public class PacketTypes {
   ...
   public static final HashSet<PacketTypes.PacketType> packetTypesLogExcludeFilter;
   ...
   public static enum PacketType {
      ...
      Vehicles(5, 1, 2, 63, PacketTypes.PacketAuthorization.Policy.Kick, GameServer::receiveVehicles, GameClient::receiveVehicles, GameClient::receiveVehiclesLoading),
      ...
      VehiclesUnreliable(7, 2, 0, 63, PacketTypes.PacketAuthorization.Policy.Kick, GameServer::receiveVehicles, GameClient::receiveVehicles, GameClient::receiveVehiclesLoading),
      ...
      SteamGeneric(14, 1, 2, 63, PacketTypes.PacketAuthorization.Policy.Kick, GameServer::receiveSteamGeneric, (PacketTypes.CallbackClientProcess)null, (PacketTypes.CallbackClientProcess)null),
      ...
      ConnectionDetails(21, 1, 2, 0, PacketTypes.PacketAuthorization.Policy.Kick, (PacketTypes.CallbackServerProcess)null, GameClient::receiveConnectionDetails, GameClient::receiveConnectionDetails),
      ...
      KillZombie(30, 1, 2, 0, PacketTypes.PacketAuthorization.Policy.Kick, (PacketTypes.CallbackServerProcess)null, GameClient::receiveKillZombie, (PacketTypes.CallbackClientProcess)null),
      ...
      RequestData(37, 1, 3, 63, PacketTypes.PacketAuthorization.Policy.Kick, GameServer::receiveRequestData, GameClient::receiveRequestData, GameClient::receiveRequestData),
      ...
      PacketCounts(47, 1, 2, 2, PacketTypes.PacketAuthorization.Policy.Kick, GameServer::receivePacketCounts, GameClient::receivePacketCounts, (PacketTypes.CallbackClientProcess)null),
      ...
      ObjectModData(58, 1, 2, 63, PacketTypes.PacketAuthorization.Policy.Kick, GameServer::receiveObjectModData, GameClient::receiveObjectModData, (PacketTypes.CallbackClientProcess)null),
      ...
      AddCorpseToMap(69, 1, 2, 63, PacketTypes.PacketAuthorization.Policy.Kick, GameServer::receiveAddCorpseToMap, GameClient::receiveAddCorpseToMap, (PacketTypes.CallbackClientProcess)null),
      ...
      Kicked(83, 0, 2, 0, PacketTypes.PacketAuthorization.Policy.Kick, (PacketTypes.CallbackServerProcess)null, GameClient::receiveKicked, GameClient::receiveKickedLoading),
      ...
      public void onServerPacket(ByteBuffer var1, UdpConnection var2) throws Exception {
         if (PacketTypes.PacketAuthorization.isAuthorized(var2, this)) {
            if (Core.bDebug && DebugLog.isEnabled(DebugType.NetworkPacketDebug) && !PacketTypes.packetTypesLogExcludeFilter.contains(this)) {
               DebugLog.NetworkPacketDebug.debugln("type=%s username=%s connection=%d ip=%s", this.name(), var2.username, var2.getConnectedGUID(), var2.ip);
            }
   ...
   private static class PacketAuthorization {
      ...
      private static void unauthorizedPacketPolicyLogUser(UdpConnection var0, String var1) {
         if (ServerOptions.instance.AntiCheatProtectionType8.getValue()) {
            PacketValidator.doLogUser(var0, var1, "UI_ValidationFailed_Type8");
         }
      ...
      private static void unauthorizedPacketPolicyKickUser(UdpConnection var0, String var1) {
         if (ServerOptions.instance.AntiCheatProtectionType8.getValue()) {
            PacketValidator.doKickUser(var0, var1, "UI_ValidationFailed_Type8");
         }
      ...
      private static void unauthorizedPacketPolicyBanUser(UdpConnection var0, String var1) throws Exception {
         if (ServerOptions.instance.AntiCheatProtectionType8.getValue()) {
            PacketValidator.doBanUser(var0, var1, "UI_ValidationFailed_Type8");
         }
      ...
      private static boolean isAuthorized(UdpConnection var0, PacketTypes.PacketType var1) throws Exception {
         ...
         if ((!var2 || var1.serverProcess == null) && !Core.bDebug) {
