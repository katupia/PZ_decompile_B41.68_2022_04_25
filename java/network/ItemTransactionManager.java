      ...
      try {
         ...
         if (0 == var3) {
            if (isConsistent(var4, var5, var6)) {
               ...
               DebugLog.Multiplayer.debugln("set accepted [ %d : %d => %d ]", var4, var5, var6);
            } else {
               sendItemTransaction(var1, (byte)1, var4, var5, var6);
               DebugLog.Multiplayer.debugln("set rejected [ %d : %d => %d ]", var4, var5, var6);
            }
         } else {
            requests.removeIf((var3x) -> {
               return var0 == var3x.itemID && var1 == var3x.srcID && var2 == var3x.dstID;
            });
            DebugLog.Multiplayer.debugln("remove processed [ %d : %d => %d ]", var4, var5, var6);
         }
