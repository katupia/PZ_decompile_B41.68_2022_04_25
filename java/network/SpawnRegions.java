...
public class SpawnRegions {
   ...
   private ArrayList<SpawnRegions.Profession> parseProfessionsTable(KahluaTable var1) {
      ArrayList var2 = null;
   ...
   private ArrayList<SpawnRegions.Point> parsePointsTable(KahluaTable var1) {
      ArrayList var2 = null;
      KahluaTableIterator var3 = var1.iterator();
   ...
   public ArrayList<SpawnRegions.Region> loadRegionsFile(String var1) {
   ...
   public boolean saveRegionsFile(String var1, ArrayList<SpawnRegions.Region> var2) {
   ...
   public ArrayList<SpawnRegions.Profession> loadPointsFile(String var1) {
      File var2 = new File(var1);
      if (!var2.exists()) {
         return null;
      } else {
   ...
   public boolean savePointsFile(String var1, ArrayList<SpawnRegions.Profession> var2) {
      File var3 = new File(var1);
      DebugLog.log("writing " + var1);
