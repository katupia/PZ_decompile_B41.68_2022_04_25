...
public class Player extends Character implements INetworkPacket {
   ...
   void attack(HandWeapon var1, boolean var2) {
      ...
      } else if (GameServer.bServer && var2) {
         this.player.setSafetyCooldown(this.player.getSafetyCooldown() + (float)ServerOptions.getInstance().SafetyCooldownTimer.getValue());
      }
