...
public class PlayerHitZombiePacket extends PlayerHitPacket implements INetworkPacket {
   ...
   public boolean validate(UdpConnection var1) {
      if (!PacketValidator.checkType3(var1, this.wielder, this.target, PlayerHitZombiePacket.class.getSimpleName())) {
         return false;
      } else {
         return PacketValidator.checkType4(var1, this.hit, PlayerHitZombiePacket.class.getSimpleName());
      }
   }
}
