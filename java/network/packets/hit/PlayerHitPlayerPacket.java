...
public class PlayerHitPlayerPacket extends PlayerHitPacket implements INetworkPacket {
   ...
   public boolean validate(UdpConnection var1) {
      if (!PacketValidator.checkType1(var1, this.wielder, this.target, PlayerHitPlayerPacket.class.getSimpleName())) {
         return false;
      } else if (!PacketValidator.checkType3(var1, this.wielder, this.target, PlayerHitPlayerPacket.class.getSimpleName())) {
         return false;
      } else {
         return PacketValidator.checkType4(var1, this.hit, PlayerHitPlayerPacket.class.getSimpleName());
      }
   }
