...
public class ServerOptions {
   ...
   public ServerOptions.IntegerServerOption PingLimit = new ServerOptions.IntegerServerOption(this, "PingLimit", 100, 2147483647, 400);
   public ServerOptions.IntegerServerOption HoursForLootRespawn = new ServerOptions.IntegerServerOption(this, "HoursForLootRespawn", 0, 2147483647, 0);
   public ServerOptions.IntegerServerOption MaxItemsForLootRespawn = new ServerOptions.IntegerServerOption(this, "MaxItemsForLootRespawn", 1, 2147483647, 4);
   ...
   public ServerOptions.IntegerServerOption SaveWorldEveryMinutes = new ServerOptions.IntegerServerOption(this, "SaveWorldEveryMinutes", 0, 2147483647, 0);
   ...
   public ServerOptions.IntegerServerOption SafehouseDaySurvivedToClaim = new ServerOptions.IntegerServerOption(this, "SafehouseDaySurvivedToClaim", 0, 2147483647, 0);
   public ServerOptions.IntegerServerOption SafeHouseRemovalTime = new ServerOptions.IntegerServerOption(this, "SafeHouseRemovalTime", 0, 2147483647, 144);
   ...
   public ServerOptions.StringServerOption ServerPlayerID = new ServerOptions.StringServerOption(this, "ServerPlayerID", Integer.toString(Rand.Next(2147483647)), -1);
   ...
   public ServerOptions.IntegerServerOption MaxAccountsPerUser = new ServerOptions.IntegerServerOption(this, "MaxAccountsPerUser", 0, 2147483647, 0);
   ...
   public ServerOptions.IntegerServerOption FactionDaySurvivedToCreate = new ServerOptions.IntegerServerOption(this, "FactionDaySurvivedToCreate", 0, 2147483647, 0);
   public ServerOptions.IntegerServerOption FactionPlayersRequiredForTag = new ServerOptions.IntegerServerOption(this, "FactionPlayersRequiredForTag", 1, 2147483647, 1);
