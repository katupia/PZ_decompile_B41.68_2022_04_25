...
public class LoginQueue {
   ...
   public static void receiveClientLoginQueueRequest(ByteBuffer var0, short var1) {
      ...
      ConnectionManager.log("Receive client queue request", (UdpConnection)null);
   }
   ...
   public static void receiveLoginQueueDone(ByteBuffer var0, UdpConnection var1, short var2) {
      ...
      ConnectionManager.log("Receive queue done", var1);
   }
   ...
   public static void receiveServerLoginQueueRequest(ByteBuffer var0, UdpConnection var1, short var2) {
      ...
      ConnectionManager.log("Receive server queue request", var1);
   }
   ...
   public static String getDescription() {
      ...
      return "login-queue=[" + var10000 + "/" + PreferredLoginQueue.size() + "/\"" + (currentLoginQueue == null ? "" : currentLoginQueue.getConnectedGUID()) + "\"]";
   }
