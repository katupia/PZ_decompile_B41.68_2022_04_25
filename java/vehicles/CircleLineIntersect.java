...
public class CircleLineIntersect {
   ...
   public static CircleLineIntersect.Collideresult checkforcecirclescollidetime(List<CircleLineIntersect.ForceCircle> var0, ArrayList<CircleLineIntersect.StaticLine> var1, double[] var2, boolean[] var3, boolean var4) {
   ...
   public static CircleLineIntersect.Collideresult checkforcecirclescollide(List<CircleLineIntersect.ForceCircle> var0, ArrayList<CircleLineIntersect.StaticLine> var1, double[] var2, boolean[] var3, boolean var4) {
   ...
   public static CircleLineIntersect.Collideresult checkforcecirclescollide(List<CircleLineIntersect.ForceCircle> var0, ArrayList<CircleLineIntersect.StaticLine> var1) {
   ...
   static class Collideresult {
      ...
      public Collideresult(CircleLineIntersect.PointVector[] var1, CircleLineIntersect.Collideclassindex[] var2, ArrayList<Integer> var3, double[] var4, double[] var5, boolean[] var6) {
