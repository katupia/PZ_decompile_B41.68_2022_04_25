...
public final class BaseVehicle extends IsoMovingObject implements Thumpable, IFMODParameterUpdater {
   ...
   public float savedPhysicsZ = 0.0F / 0.0;
   ...
   public void switchSeat(IsoGameCharacter var1, int var2) {
      ...
      if (var3 != -1) {
         ...
         VehicleManager.instance.sendSwitchSeat(this, var2, var1);
      }
   }
   ...
   public void update() {
      if (this.removedFromWorld) {
         ...
         if (this.chunk == null) {
            ...
            if (GameClient.bClient) {
               VehicleManager.instance.sendRequestGetPosition(this.VehicleID);
            }
         ...
         if (this.physics != null) {
            ...
            if (System.currentTimeMillis() - this.engineCheckTime > (long)var26 && !GameClient.bClient) {
               ...
               if (this.engineState == BaseVehicle.engineStateTypes.Running) {
                  VehiclePart var32 = this.getPartById("Engine");
                  if (var32 != null && var32.getCondition() < 50 && Rand.Next(Rand.AdjustForFramerate(var32.getCondition() * 12)) == 0) {
                     this.shutOff();
                  }
               }
            ...
            this.setZ(0.0F);
            IsoGridSquare var33 = this.getCell().getGridSquare((double)this.x, (double)this.y, (double)this.z);
            if (var33 == null && !this.chunk.refs.isEmpty()) {
               float var28 = 5.0E-4F;
            ...
            this.updateTransform();
            Vector3f var30 = allocVector3f().set(GameServer.bServer ? this.netLinearVelocity : this.jniLinearVelocity);
            if (this.jniIsCollide && this.limitCrash.Check()) {
               this.jniIsCollide = false;
               this.limitCrash.Reset();
               Vector3f var31 = allocVector3f();
               var31.set(var30).sub(this.lastLinearVelocity);
               var31.y = 0.0F;
               float var34 = var31.length();
               if (DebugLog.isEnabled(DebugType.Vehicle)) {
                  short var10001 = this.VehicleID;
                  DebugLog.log(DebugType.Vehicle, "Vehicle #" + var10001 + " last velocity=" + this.lastLinearVelocity + "/" + this.lastLinearVelocity.length() + " current velocity=" + var30 + "/" + var30.length() + " delta=" + var34);
               }

               if (var30.lengthSquared() > this.lastLinearVelocity.lengthSquared() && var34 > 4.0F) {
                  DebugLog.log(DebugType.Vehicle, "Vehicle #" + this.VehicleID + " received a sharp increase in speed: delta=" + var34);
                  var34 = 4.0F;
               }
               ...
               if (var34 > 1.0F) {
                  ...
                  if (Core.bDebug) {
                     DebugLog.log(DebugType.Vehicle, "CRASH ID=" + this.VehicleID + " delta=" + var34);
                  }

                  Vector3f var35 = this.getForwardVector(allocVector3f());
                  float var36 = var31.dot(var35);
                  releaseVector3f(var35);
                  this.crash(var34 * 3.0F, var36 < 0.0F);
                  this.damageObjects(var34 * 30.0F);
               }

               releaseVector3f(var31);
            }

            this.lastLinearVelocity.set(var30);
            releaseVector3f(var30);
         }
   ...
   public void netPlayerFromServerUpdate(byte var1, short var2) {
      if (var1 != this.netPlayerAuthorization || this.netPlayerId != var2) {
         if (var1 == 3) {
   ...
   public Vector3f getLinearVelocity(Vector3f var1) {
      if (GameServer.bServer) {
         var1.set(this.netLinearVelocity);
         return var1;
      } else {
         var1.set(this.jniLinearVelocity);
         return var1;
      }
   }
   ...
   public void addPointConstraint(BaseVehicle var1, String var2, String var3, Float var4, Boolean var5) {
      ...
      var1.breakConstraint(true, var5);
   ...
   private void tryReconnectToTowedVehicle() {
      if (GameClient.bClient) {
         ...
         if (var5 != -1) {
            ...
            if (var6 != null) {
               if (this.canAttachTrailer(var6, this.towAttachmentSelf, this.towAttachmentOther)) {
                  this.addPointConstraint(var6, this.towAttachmentSelf, this.towAttachmentOther, this.towConstraintZOffset, true);
               }
            }
         }
   ...
   public BaseVehicle setSmashed(String var1, boolean var2) {
      ...
      if (var3 != null) {
         ...
         var8.savedRot.set(this.savedRot);
         if (var2) {
