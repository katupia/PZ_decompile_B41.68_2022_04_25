...
public final class UI3DScene extends UIElement {
   ...
   private final ArrayList<UI3DScene.PositionRotation> m_axes;
   ...
   private final ArrayList<UI3DScene.AABB> m_aabb;
   private static final ObjectPool<UI3DScene.AABB> s_aabbPool = new ObjectPool(UI3DScene.AABB::new);
   private final ArrayList<UI3DScene.Box3D> m_box3D;
   ...
   int intersect_ray_plane(UI3DScene.Plane var1, UI3DScene.Ray var2, Vector3f var3) {
      Vector3f var4 = allocVector3f().set(var2.direction).mul(100.0F);
   ...
   private static final class StateData {
      ...
      final ArrayList<UI3DScene.AABB> m_aabb;
      final ArrayList<UI3DScene.Box3D> m_box3D;
   ...
   private final class RotateGizmo extends UI3DScene.Gizmo {
      ...
      private float hitTestCircle(UI3DScene.Ray var1, ArrayList<Vector3f> var2, Vector2 var3) {
         ...
         if (Core.bDebug && DebugOptions.instance.ModelRenderWireframe.getValue()) {
            ...
            if (var4 != null && var4.isVehicleShader()) {
               ...
               for(var5 = 0; var5 < 5; ++var5) {
                  var4.setLight(var5, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F / 0.0, 0.0F, 0.0F, 0.0F, (IsoMovingObject)null);
               }
      ...
      public void render() {
         ...
         if (var3 != null && var2.Mesh != null && var2.Mesh.isReady()) {
            ...
            for(int var4 = 0; var4 < 5; ++var4) {
               var3.setLight(var4, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F / 0.0, 0.0F, 0.0F, 0.0F, (IsoMovingObject)null);
            }
