...
public class CollideWithObstaclesPoly {
   ...
   public Vector2f resolveCollision(IsoGameCharacter var1, float var2, float var3, Vector2f var4) {
      ...
      if (var6 == var2 && var7 == var3) {
         ...
         this.closestPointOnEdge.distSq = 1.7976931348623157E308D;
   ...
   public static final class ChunkDataZ {
      ...
      private void clipperToObstacles(Clipper var1, ByteBuffer var2, ArrayList<CollideWithObstaclesPoly.CCObstacle> var3) {
   ...
   private static final class CCObstacle {
      ...
      static final ObjectPool<CollideWithObstaclesPoly.CCObstacle> pool = new ObjectPool<CollideWithObstaclesPoly.CCObstacle>(CollideWithObstaclesPoly.CCObstacle::new) {
   ...
   private static final class CCEdgeRing extends ArrayList<CollideWithObstaclesPoly.CCEdge> {
      static final ObjectPool<CollideWithObstaclesPoly.CCEdgeRing> pool = new ObjectPool<CollideWithObstaclesPoly.CCEdgeRing>(CollideWithObstaclesPoly.CCEdgeRing::new) {
