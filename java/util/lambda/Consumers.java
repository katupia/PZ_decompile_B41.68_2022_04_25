...
public final class Consumers {
   ...
   public static final class Params5 {
      ...
      public static final class CallbackStackItem<E, T1, T2, T3, T4, T5> extends Consumers.Params5.StackItem<T1, T2, T3, T4, T5> implements Consumer<E> {
         ...
         private static final Pool<Consumers.Params5.CallbackStackItem<Object, Object, Object, Object, Object, Object>> s_pool = new Pool(Consumers.Params5.CallbackStackItem::new);
         ...
         public static <E, T1, T2, T3, T4, T5> Consumers.Params5.CallbackStackItem<E, T1, T2, T3, T4, T5> alloc(T1 var0, T2 var1, T3 var2, T4 var3, T5 var4, Consumers.Params5.ICallback<E, T1, T2, T3, T4, T5> var5) {
   ...
   public static final class Params4 {
      ...
      public static final class CallbackStackItem<E, T1, T2, T3, T4> extends Consumers.Params4.StackItem<T1, T2, T3, T4> implements Consumer<E> {
         ...
         private static final Pool<Consumers.Params4.CallbackStackItem<Object, Object, Object, Object, Object>> s_pool = new Pool(Consumers.Params4.CallbackStackItem::new);
         ...
         public static <E, T1, T2, T3, T4> Consumers.Params4.CallbackStackItem<E, T1, T2, T3, T4> alloc(T1 var0, T2 var1, T3 var2, T4 var3, Consumers.Params4.ICallback<E, T1, T2, T3, T4> var4) {
   ...
   public static final class Params3 {
      ...
      public static final class CallbackStackItem<E, T1, T2, T3> extends Consumers.Params3.StackItem<T1, T2, T3> implements Consumer<E> {
         ...
         public static <E, T1, T2, T3> Consumers.Params3.CallbackStackItem<E, T1, T2, T3> alloc(T1 var0, T2 var1, T3 var2, Consumers.Params3.ICallback<E, T1, T2, T3> var3) {
   ...
   public static class Params2 {
      ...
      public static final class CallbackStackItem<E, T1, T2> extends Consumers.Params2.StackItem<T1, T2> implements Consumer<E> {
         ...
         public static <E, T1, T2> Consumers.Params2.CallbackStackItem<E, T1, T2> alloc(T1 var0, T2 var1, Consumers.Params2.ICallback<E, T1, T2> var2) {
   ...
   public static final class Params1 {
      ...
      public static final class CallbackStackItem<E, T1> extends Consumers.Params1.StackItem<T1> implements Consumer<E> {
         ...
         public static <E, T1> Consumers.Params1.CallbackStackItem<E, T1> alloc(T1 var0, Consumers.Params1.ICallback<E, T1> var1) {
