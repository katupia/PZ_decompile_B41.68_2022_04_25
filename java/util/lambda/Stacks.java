...
public final class Stacks {
   ...
   public static final class Params6 {
      ...
      public static final class CallbackStackItem<T1, T2, T3, T4, T5, T6> extends Stacks.Params6.StackItem<T1, T2, T3, T4, T5, T6> {
         ...
         private static final Pool<Stacks.Params6.CallbackStackItem<Object, Object, Object, Object, Object, Object>> s_pool = new Pool(Stacks.Params6.CallbackStackItem::new);
         ...
         public static <T1, T2, T3, T4, T5, T6> Stacks.Params6.CallbackStackItem<T1, T2, T3, T4, T5, T6> alloc(T1 var0, T2 var1, T3 var2, T4 var3, T5 var4, T6 var5, Stacks.Params6.ICallback<T1, T2, T3, T4, T5, T6> var6) {
   ...
   public static final class Params5 {
      ...
      public static final class CallbackStackItem<T1, T2, T3, T4, T5> extends Stacks.Params5.StackItem<T1, T2, T3, T4, T5> {
         ...
         public static <T1, T2, T3, T4, T5> Stacks.Params5.CallbackStackItem<T1, T2, T3, T4, T5> alloc(T1 var0, T2 var1, T3 var2, T4 var3, T5 var4, Stacks.Params5.ICallback<T1, T2, T3, T4, T5> var5) {
   ...
   public static final class Params4 {
      ...
      public static final class CallbackStackItem<T1, T2, T3, T4> extends Stacks.Params4.StackItem<T1, T2, T3, T4> {
         ...
         public static <T1, T2, T3, T4> Stacks.Params4.CallbackStackItem<T1, T2, T3, T4> alloc(T1 var0, T2 var1, T3 var2, T4 var3, Stacks.Params4.ICallback<T1, T2, T3, T4> var4) {
   ...
   public static final class Params3 {
      ...
      public static final class CallbackStackItem<T1, T2, T3> extends Stacks.Params3.StackItem<T1, T2, T3> {
         ...
         public static <T1, T2, T3> Stacks.Params3.CallbackStackItem<T1, T2, T3> alloc(T1 var0, T2 var1, T3 var2, Stacks.Params3.ICallback<T1, T2, T3> var3) {
   ...
   public static final class Params2 {
      ...
      public static final class CallbackStackItem<T1, T2> extends Stacks.Params2.StackItem<T1, T2> {
         ...
         public static <T1, T2> Stacks.Params2.CallbackStackItem<T1, T2> alloc(T1 var0, T2 var1, Stacks.Params2.ICallback<T1, T2> var2) {
   ...
   public static final class Params1 {
      ...
      public static final class CallbackStackItem<T1> extends Stacks.Params1.StackItem<T1> {
         ...
         public static <T1> Stacks.Params1.CallbackStackItem<T1> alloc(T1 var0, Stacks.Params1.ICallback<T1> var1) {
