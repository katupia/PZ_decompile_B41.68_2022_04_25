...
public final class HairOutfitDefinitions {
   ...
   private static ArrayList<HairOutfitDefinitions.StringChance> initStringChance(String var0) {
   ...
   public static final class HaircutDefinition {
      ...
      public HaircutDefinition(String var1, int var2, ArrayList<String> var3) {
         this.hairStyle = var1;
   ...
   public static final class HaircutOutfitDefinition {
      ...
      public HaircutOutfitDefinition(String var1, ArrayList<HairOutfitDefinitions.StringChance> var2, ArrayList<HairOutfitDefinitions.StringChance> var3, ArrayList<HairOutfitDefinitions.StringChance> var4) {
         this.outfit = var1;
