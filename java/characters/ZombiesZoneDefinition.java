...
public final class ZombiesZoneDefinition {
   ...
   private static ArrayList<ZombiesZoneDefinition.StringChance> initStringChance(String var0) {
   ...
   public static ZombiesZoneDefinition.ZZDOutfit getRandomOutfitInSetList(ArrayList<ZombiesZoneDefinition.ZZDOutfit> var0, boolean var1) {
      float var2 = 0.0F;
   ...
   private static String getRandomHairOrBeard(ArrayList<ZombiesZoneDefinition.StringChance> var0) {
