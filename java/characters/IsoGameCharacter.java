...
public abstract class IsoGameCharacter extends IsoMovingObject implements Talker, ChatElementOwner, IAnimatable, IAnimationVariableMap, IClothingItemListener, IActionStateChanged, IAnimEventCallback, IFMODParameterUpdater, ILuaVariableSource, ILuaGameCharacter {
   ...
   public void renderlast() {
      ...
      if (Core.bDebug) {
         ...
         if (DebugOptions.instance.MultiplayerShowZombieStatus.getValue() && this instanceof IsoZombie || DebugOptions.instance.MultiplayerShowPlayerStatus.getValue() && this instanceof IsoPlayer) {
   ...
   public void HitSilence(HandWeapon var1, IsoGameCharacter var2, boolean var3, float var4) {
      if (var2 != null && var1 != null) {
         if (this.getStateMachine().getCurrent() != StaggerBackState.instance()) {
            ...
            if (WeaponType.getWeaponType(var2) == WeaponType.barehand || var2 instanceof IsoPlayer && ((IsoPlayer)var2).bDoShove) {
               var3 = true;
               this.noDamage = true;
            }
         ...
         if (GameServer.bServer && this.chr instanceof IsoPlayer) {
            if (System.currentTimeMillis() - this.lastXPTime > 60000L) {
               ...
               if ((double)this.lastXPGrowthRate > 1000.0D * SandboxOptions.instance.XpMultiplier.getValue() * ServerOptions.instance.AntiCheatProtectionType9ThresholdMultiplier.getValue()) {
                  ...
                  if (ServerOptions.instance.AntiCheatProtectionType9.getValue() && PacketValidator.doKickUser(var4, this.getClass().getSimpleName(), "UI_ValidationFailed_Type9")) {
                     LoggerManager.getLogger("kick").write(String.format("Kick: player=\"%s\" type=\"%s\" issuer=\"%s\"", var4.username, "UI_ValidationFailed_Type9", this.getClass().getSimpleName()));
                     ...
                     LoggerManager.getLogger("user").write(String.format("Warning: player=\"%s\" type=\"%s\" issuer=\"%s\"", var4.username, "UI_ValidationFailed_Type9", this.getClass().getSimpleName()));
                  }
               }
            }
