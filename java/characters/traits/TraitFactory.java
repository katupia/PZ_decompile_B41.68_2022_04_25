...
public final class TraitFactory {
   ...
   public static void sortList() {
      ...
      Collections.sort(var0, new Comparator<Entry<String, TraitFactory.Trait>>() {
         public int compare(Entry<String, TraitFactory.Trait> var1, Entry<String, TraitFactory.Trait> var2) {
