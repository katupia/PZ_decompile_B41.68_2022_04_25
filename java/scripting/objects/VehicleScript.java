...
public final class VehicleScript extends BaseScriptObject {
   ...
   private VehicleScript.Model LoadModel(ScriptParser.Block var1, ArrayList<VehicleScript.Model> var2) {
   ...
   private VehicleScript.Anim LoadAnim(ScriptParser.Block var1, ArrayList<VehicleScript.Anim> var2) {
   ...
   private VehicleScript.Position LoadPosition(ScriptParser.Block var1, ArrayList<VehicleScript.Position> var2) {
   ...
   public VehicleScript.Model getModelById(String var1, ArrayList<VehicleScript.Model> var2) {
   ...
   private VehicleScript.Anim getAnimationById(String var1, ArrayList<VehicleScript.Anim> var2) {
      for(int var3 = 0; var3 < var2.size(); ++var3) {
   ...
   private VehicleScript.Position getPositionById(String var1, ArrayList<VehicleScript.Position> var2) {
      for(int var3 = 0; var3 < var2.size(); ++var3) {
