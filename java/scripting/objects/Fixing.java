...
public final class Fixing extends BaseScriptObject {
   ...
   public ArrayList<InventoryItem> getRequiredFixerItems(IsoGameCharacter var1, Fixing.Fixer var2, InventoryItem var3, ArrayList<InventoryItem> var4) {
      if (var2 == null) {
         return null;
      } else {
   ...
   public ArrayList<InventoryItem> getRequiredItems(IsoGameCharacter var1, Fixing.Fixer var2, InventoryItem var3) {
   ...
   public static final class Fixer {
      ...
      public Fixer(String var1, LinkedList<Fixing.FixerSkill> var2, int var3) {
         this.fixerName = var1;
         this.skills = var2;
