...
public abstract class WorldMapStyleLayer {
   ...
   static <S extends WorldMapStyleLayer.Stop> int findStop(float var0, ArrayList<S> var1) {
      if (var1.isEmpty()) {
         return -2;
   ...
   protected WorldMapStyleLayer.RGBAf evalColor(WorldMapStyleLayer.RenderArgs var1, ArrayList<WorldMapStyleLayer.ColorStop> var2) {
      if (var2.isEmpty()) {
   ...
   protected float evalFloat(WorldMapStyleLayer.RenderArgs var1, ArrayList<WorldMapStyleLayer.FloatStop> var2) {
      if (var2.isEmpty()) {
         return 1.0F;
      } else {
         float var3 = var1.drawer.m_zoomF;
   ...
   protected Texture evalTexture(WorldMapStyleLayer.RenderArgs var1, ArrayList<WorldMapStyleLayer.TextureStop> var2) {
      if (var2.isEmpty()) {
         return null;
      } else {
         float var3 = var1.drawer.m_zoomF;
