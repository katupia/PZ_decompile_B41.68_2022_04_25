...
public class StrokeGeometry {
   ...
   static void release(ArrayList<StrokeGeometry.Point> var0) {
   ...
   static ArrayList<StrokeGeometry.Point> getStrokeGeometry(StrokeGeometry.Point[] var0, StrokeGeometry.Attrs var1) {
      if (var0.length < 2) {
         return null;
      } else {
   ...
   static void createSquareCap(StrokeGeometry.Point var0, StrokeGeometry.Point var1, StrokeGeometry.Point var2, ArrayList<StrokeGeometry.Point> var3) {
      var3.add(var0);
   ...
   static void createRoundCap(StrokeGeometry.Point var0, StrokeGeometry.Point var1, StrokeGeometry.Point var2, StrokeGeometry.Point var3, ArrayList<StrokeGeometry.Point> var4) {
   ...
   static void createTriangles(StrokeGeometry.Point var0, StrokeGeometry.Point var1, StrokeGeometry.Point var2, ArrayList<StrokeGeometry.Point> var3, float var4, String var5, float var6) {
