...
public class WorldMapSymbols {
   ...
   void checkLayout(UIWorldMap var1) {
      Quaternionf var2 = ((Quaternionf)((BaseVehicle.QuaternionfObjectPool)BaseVehicle.TL_quaternionf_pool.get()).alloc()).setFromUnnormalized(var1.getAPI().getRenderer().getModelViewMatrix());
